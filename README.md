...
<body>
    <div class="banner">
        <br>
        <div class="navbar">
            <h1 class="logo">St<span>anz</span>T<span>ech</span></h1>
            <ul>
    ...
    <footer>
        <center> Designed and Developed by STANLEY S (212223110054) </center>
    </footer>
</body>
</html>
```
    ...
    <div class="banner">
        ...
        <div class="container">
            <div class="box-container">
                ...
                <div class="box">
                    <img src="c program logo.png" alt="">
                    <h3>C pgg </h3>
...
<body>
    <div class="banner">
        ...
        <div class="box">
            ...
            <div class="box-2"> 
                <h2> CONTACT INFO </h2>
                <p> <span>Address</span> : No:943A,32nd Street,Phase-II,Sathuvachari,Vellore </p>
                <p> <span>Email</span> : StanzTech@gmail.com.com </p>
                <p> <span>Phone</span> : 9360453459</p>
            </div>
        </div>
    </div>
    <footer>
...
## OUTPUT:
![alt text](Stanztech1.png)
![alt text](Stanztech2.png)
![alt text](Stanztech3.png)
![alt text](Stanztech4.png)
